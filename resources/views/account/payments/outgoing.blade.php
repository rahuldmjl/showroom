...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
      <!-- /.page-title-right -->
      {{ Breadcrumbs::render('accountpayment.outgoing') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
      ...
      <div class="col-md-12 widget-holder">
        <div class="widget-bg">
          <div class="widget-heading clearfix">
            <h5 class="border-b-light-1 w-100 pb-1 mt-0 mb-2">{{'OutGoing'}}</h5>
          </div>
          <!-- /.widget-heading -->
          <div class="widget-body clearfix dataTable-length-top-0">
            ...
            <table class="outgoing table table-striped table-center" >
              <thead>
                <tr class="bg-primary">
                  <th>No</th>
                  <th>Customer Name</th>
                ...
                @foreach ($results as $key => $value)
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="" href="javascript:void(0);" onclick="event.preventDefault();declinepayment('{{$value->id}}', '{{ csrf_token() }}');" data-token="{{ csrf_token() }}"><i class="material-icons" style="color:red;" title="Decline"> highlight_off</i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('.outgoing').DataTable({
      "dom":"<'row'<'col col-lg-3'l>><'row'<'col'B><'col'f>>"+"<'row'<'col-sm-12' <'scroll-lg' tr>>>"
      ...
      "serverMethod": "GET",
      "ajax":{
        "url": "{{action('PaymentController@outgoingresponse')}}",
