...
<main class="main-wrapper clearfix">
    ...
    <div class="row page-title clearfix">
        {{ Breadcrumbs::render('purchasehistory.editgold',$transaction->id) }}
        <!-- /.page-title-right -->
    </div>
    <!-- /.page-title -->
    <!-- =================================== -->
            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        {!! Form::model($transaction, ['method' => 'PATCH','route' => ['purchasehistory.updategold', $transaction->id],'files'=>'true','id'=>'metaltransaction_form']) !!}
                            <div class="row ">
                                    ...
                                    <div class="vendorhid">
                                        <div class="form-group">
                                            <label for="l30">Vendor Name</label>
                                             ...
                                             {!! Form::text('vendor_name' ,$transaction->vendor->name, array('autocomplete' => 'off', 'class' => 'form-control','id'=>'search_text')) !!}
                               ...
                               <!-- <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                  ...
                                  <a target="_blank" href="<?=URL::to(config('constants.dir.purchased_invoices') . '/' . $transaction->purchased_invoice)?>"><?=$transaction->purchased_invoice?></a>
                                     ...
                                     <input type="hidden" name="oldinvoice" value="{{$transaction->purchased_invoice}}">
                                </div>
