            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        ...
                        <p class="text-muted">You can modify Product details here in this form</p>
                        ...
                        {!! Form::model($product, ['method' => 'PATCH','action' => ['ProductTypeController@update', $product->vendor_product_id],'id'=>'edit_product_type_form']) !!}
                            <div class="row">
                                <div class="col-lg-12">
