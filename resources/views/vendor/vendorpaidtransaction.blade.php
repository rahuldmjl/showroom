          ...
          <div class="col-md-12 widget-holder">
              <div class="widget-bg">
                  <div class="widget-heading clearfix">
                      <h5 class="border-b-light-1 w-100 pb-1 mt-0 mb-4">{{'Paid Transaction'}}</h5>
                  </div>
                  <!-- /.widget-heading -->
                    <div class="widget-body clearfix dataTable-length-top-0">
                      ...
                      @endforeach
                      <a href="{{ URL::previous() }}#paid-invoice" class="btn btn-info btn-top-right2 small-btn-style">Go Back</a>
...
<script type="text/javascript">
  ...
  "serverMethod": "post",
  "ajax":{
    "url": "{{action('VendorController@vendorpaidtransactionresponse')}}",
