...
@section('title', 'Costing Return Memo')
...
<main class="main-wrapper clearfix">
  ...
  <div class="row page-title clearfix">
      {{ Breadcrumbs::render('costing.qcreturnmemo') }}
      <!-- /.page-title-right -->
  </div>
  <!-- /.page-title -->
  <!-- =================================== -->
          ...
          <div class="col-md-12 widget-holder">
              <div class="widget-bg">
                  <div class="widget-heading clearfix">
                      <h5 class="border-b-light-1 pb-1 mb-2 mt-0 w-100">{{'Costing Return Memo'}}</h5>
                  </div>
                    ...
                    <div class="widget-body clearfix dataTable-length-top-0">
                      <table class="table-head-box table-center table table-striped table-responsive" id="qcReturnMemoTable">
                            <thead>
                              <tr class="bg-primary">
                                  <th>Sku</th>
...
$('#qcReturnMemoTable').DataTable({
      "processing": true,
      "serverSide": true,
      "deferLoading": <?=$totalcount?>,
      "ajax":{
               "url": "<?=URL::to('/').'/costing/qcreturnmemoResponse' ?>",
               "dataType": "json",
               "type": "GET",
