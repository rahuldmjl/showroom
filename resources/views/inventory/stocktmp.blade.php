...
?>
                              ...
                              <div class="col-xl-2 col-sm-4">
                                  <div class="form-group diamond-shape-filter">
                                      <?php
          ...
          <div class="col-md-12 widget-holder content-area">
              ...
              <div class="widget-bg">
                  ...
                  <div class="widget-body clearfix">
                      ...
                      <table class="table table-striped table-center table-head-box checkbox checkbox-primary " id="inventoryProductsTable" style="overflow-x: auto;display: block;">
                          <thead>
                              <tr class="bg-primary">
...
<div class="modal fade bs-modal-lg" id="invoice-memo-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::open(array('method'=>'POST','id'=>'invoicememo-generate-form','class'=>'form-horizontal','autocomplete'=>'nope')) !!}
...
$(document).on('change', '.category_chkbox,#virtualproductmanager,#stockstatus,.chk_metalquality,.chk_metalcolor,.chk_diamondquality,.chk_diamondshape',function(){
  ...
  appliedFilterType = $(this).attr('class');
  getProminentFilters();
});
//For price filter
