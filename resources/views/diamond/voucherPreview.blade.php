...
<html lang="en">
  ...
  <style type="text/css">
    .issue-voucher-recovered *{font-family: aparjit;letter-spacing: 0.6px;font-size: 16px;color:#000;line-height: 22px;}
    .m-lr-auto{margin-left:auto;margin-right: auto;}
    .width-100{width: 100%;}
    h4{font-family:aparaj;}
    .width-80{width:80%;}
    .width-70{width:70%;}
    .width-60{width:60%;}
    ...
    .table, .table thead th, .table tbody td{border:1px solid #040404 !important;}
...
<?php $logoname = Config::get('constants.pdf_logo.name');?>
  <!-- header start -->
  <div>
    <div class="logo text-center mr-b-10">
      <img src="<?=url('/img/logo.png');?>" class="width-200">
      <p><?php echo '<b>'.$logoname.'</b>'; ?></p>
    </div>
    <div class="text-center">
      <p>2307, Floor-23 Panchratna, Opera House, Charni Road, Mumbai-400004 Ph: 022-49664989 </p>
      <h4 class="text-uppercase text-black fw-600 fs-seventeen margin-tb-10">Preview Voucher</h4>
  ...
  <section>
    <div class="tax-invoice margin-top-3">
       <div class="label-type flex-justify-space-between">
...
?>
          ...
          if (count($data['data']) > 0) {  ?>
            ...
            <tr class="height-big1 text-center">
              ...
              <td class="text-right"><?php $value_amount_paid = (float) ($value['diamond_weight'] * $value['rate']) ;?><?php printf("%.2f", $value_amount_paid);?></td>
               </tr>
            <?php
            $amount_paid = ($value['diamond_weight'] * $value['rate']);
      ...
      if (count($data['data']) < 30) {
      $remaining_row_count = 30 - count($data['data']);
          ...
          <tr class="height-small">
           ...
           <tr class="fw-600">
            ...
            <tr>
             ...
             <tr>
               <td colspan="10">
                 <p class="margin-zero text-center text-red fs-18">“The diamonds herein invoiced have been purchased from legitimate sources not
                  involved in funding conflict, in compliance</p>
                  <p class="margin-zero text-center text-red fs-18">with United Nations Resolutions and corresponding national laws.
                  The seller hereby guarantees that these diamonds are</p>
                  <p class="margin-zero text-center text-red fs-18">conflict free and confirms adherence to the World Diamond Council System of Warranties Guidelines.”</p>
               </td>
             </tr>
             <tr>
              <td colspan="10">
